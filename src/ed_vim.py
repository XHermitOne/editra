...
def Arrows(editor, repeat, cmd):
    ...
    if cmd in cmd_map:
        ...
        if cmd == '\u013c' and not editor.IsAtLineEnd():
            # Right arrow
            editor.MoveRight()
...
def Line(editor, repeat, cmd):
    ...
    """
    cmd_map = { '0': editor.GotoLineStart,
