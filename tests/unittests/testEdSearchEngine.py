...
class EdSearchEngineTest(unittest.TestCase):
    def setUp(self):
        ...
        self._def_eng = ed_search.EdSearchEngine("", regex=False, down=True,
                                               matchcase=False, wholeword=False)
        self._ww_eng = ed_search.EdSearchEngine("", regex=False, down=True,
                                              matchcase=False, wholeword=True)
        self._mc_eng = ed_search.EdSearchEngine("", regex=False, down=True,
                                              matchcase=True, wholeword=False)
        self._regex_eng = ed_search.EdSearchEngine("", regex=True, down=True,
                                                 matchcase=False, wholeword=False)
        self._regexmc_eng = ed_search.EdSearchEngine("", regex=True, down=True,
                                                  matchcase=True, wholeword=False)
        self._regww_eng = ed_search.EdSearchEngine("", regex=True, down=True,
                                                 matchcase=False, wholeword=True)
        self._all_eng = ed_search.EdSearchEngine("", regex=True, down=True,
