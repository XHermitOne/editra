...
class StyleItemTest(unittest.TestCase):
    ...
    def testGetBack(self):
        ...
        self.assertEqual(self.item.GetBack(), "#000000")
        self.assertEqual(self.null.GetBack(), '')

    def testGetFore(self):
        """Test retrieving the background color"""
        self.assertEqual(self.item.GetFore(), "#FF0000")
        self.assertEqual(self.null.GetFore(), '')

    def testGetFace(self):
        """Test retrieving the background color"""
        self.assertEqual(self.item.GetFace(), "Times")
        self.assertEqual(self.null.GetFace(), '')

    def testGetSize(self):
        """Test retrieving the background color"""
        self.assertEqual(self.item.GetSize(), "10")
        self.assertEqual(self.null.GetSize(), '')

    def testGetModifiers(self):
        """Test retrieving the extra modifier attributes"""
        self.assertEqual(self.item.GetModifiers(), "bold")
        self.assertEqual(self.null.GetModifiers(), '')

    def testGetModifierList(self):
        """Test retrieving the extra modifier attributes list"""
        self.assertEqual(self.item.GetModifierList()[0], "bold")
        self.assertEqual(self.null.GetModifierList(), list())

    def testGetNamedAttr(self):
        """Test GetNamedAttr"""
        self.assertEqual(self.item.GetNamedAttr("fore"), self.item.GetFore())
        self.assertEqual(self.item.GetNamedAttr("back"), self.item.GetBack())
        self.assertEqual(self.item.GetNamedAttr("face"), self.item.GetFace())
        self.assertEqual(self.item.GetNamedAttr("size"), self.item.GetSize())
