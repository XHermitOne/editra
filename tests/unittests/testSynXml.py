...
class SynXmlTest(unittest.TestCase):
    def setUp(self):
        self.path = common.GetDataFilePath('syntax.xml')
        self.bad = common.GetDataFilePath('bad.xml')
    ...
    def testGetCommentPattern(self):
        ...
        self.assertEqual(self.fhandle.CommentPattern,
    ...
    def testGetFeatureFromXml(self):
        ...
        feat = self.fhandle.GetFeatureFromXml('AutoIndenter')
        self.assertEqual(feat, 'myextension.py')
    ...
    def testGetKeywords(self):
        ...
        self.assertEqual(kwords[0][0], 0, "not sorted")
        self.assertTrue('else' in kwords[0][1])
        self.assertTrue('str' in kwords[1][1])

    def testGetLangId(self):
        """Test getting the language identifier string"""
        lid = self.fhandle.GetLangId()
        self.assertEqual(lid, 'ID_LANG_PYTHON')
    ...
    def testGetProperties(self):
        ...
        self.assertEqual(props[0][0], "fold")
        self.assertEqual(props[0][1], "1")
    ...
    def testGetSyntaxSpec(self):
        ...
        self.assertEqual(spec[0][0], wx.stc.STC_P_DEFAULT,
                          "val was: %s" % spec[0][0])
        self.assertEqual(spec[0][1], "default_style",
                          "val was: %s" % spec[0][1])
        self.assertEqual(spec[1][0], wx.stc.STC_P_WORD,
                          "val was: %s" % spec[0][0])
        self.assertEqual(spec[1][1], "keyword_style",
                          "val was: %s" % spec[0][1])
    ...
    def testVersion(self):
        ...
        self.assertEqual(self.fhandle.Version, 1,
